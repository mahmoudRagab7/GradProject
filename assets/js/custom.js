(function ($) {
  ...
  validBtn.onclick = function () {
    let validEmail = document.getElementById("valid-email").value;
    let validTxt = document.getElementById("validator-newsletter");
    if (
      validEmail != "" &&
      validEmail.includes("@") &&
      validEmail.includes(".com")
    ) {
      validTxt.innerHTML = "Thank you for subscribing!";
      validTxt.style.color = "#00ca99";
    } else {
